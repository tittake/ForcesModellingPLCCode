...
geom.theta1UpperBound = 90*pi/180;
geom.theta1LowerBound = -20*pi/180;
geom.theta2UpperBound = -10*pi/180;
geom.theta2LowerBound = -90*pi/180;
geom.xt2UpperBound = cylT2.sp;
geom.xt2LowerBound = 0;